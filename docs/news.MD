...
- SEACells and SuperCells that are actually memory efficient

#### GPU-accelerated methods:

- First implementation of GPU-accelerated method:
  * k-means clustering -> to be integrated in the future in some of methods
